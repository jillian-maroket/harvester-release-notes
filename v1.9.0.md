...
Harvester now allows you to configure custom unattend.xml and autounattend.xml files when creating or editing Windows virtual machines and virtual machine templates. On the **Advanced Options** tab of the UI, you can select an existing Kubernetes Secret or create a new one with built-in XML validation, enabling automated operating system deployment in place of standard cloud-init configurations.
